...
//Esta clase esta escuchando todas las excepciones de este paquete (el que entra por parámetro)
...
public class GestionExcepciones {
	...
	public ResponseEntity<?> gestionStringOutIndexException (Throwable e) {
